...
ajax('GET', url + '/gps/api/server', function(server) {
    ajax('GET', url + '/gps/api/session?token=' + token, function(user) {
        ...
        ajax('GET', url + '/gps/api/devices', function(devices) {

            var socket = new WebSocket('ws' + url.substring(4) + '/gps/api/socket');
