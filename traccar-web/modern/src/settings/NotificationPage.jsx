...
const NotificationPage = () => {
  ...
  const testNotificators = useCatch(async () => {
    await Promise.all(item.notificators.split(/[, ]+/).map(async (notificator) => {
      const response = await fetch(`/gps/api/notifications/test/${notificator}`, {
        method: 'POST',
          ...
          <Accordion defaultExpanded>
            ...
            <AccordionDetails className={classes.details}>
              <SelectField
                ...
                endpoint="/gps/api/notifications/types"
              ...
              <SelectField
                ...
                endpoint="/gps/api/notifications/notificators"
                keyGetter={(it) => it.type}
