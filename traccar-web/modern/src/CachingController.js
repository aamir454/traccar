...
const CachingController = () => {
  ...
  useEffectAsync(async () => {
    if (authenticated) {
      const response = await fetch('/gps/api/geofences');
      if (response.ok) {
  ...
  useEffectAsync(async () => {
    if (authenticated) {
      const response = await fetch('/gps/api/groups');
      if (response.ok) {
  ...
  useEffectAsync(async () => {
    if (authenticated) {
      const response = await fetch('/gps/api/drivers');
      if (response.ok) {
  ...
  useEffectAsync(async () => {
    if (authenticated) {
      const response = await fetch('/gps/api/maintenance');
      if (response.ok) {
  ...
  useEffectAsync(async () => {
    if (authenticated) {
      const response = await fetch('/gps/api/calendars');
      if (response.ok) {
